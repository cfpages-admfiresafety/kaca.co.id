---
article_id: GLA-12-03
title: "Spesifikasi survei, penawaran, pengadaan, bukti mutu, dan garansi pekerjaan kaca: data, ukuran, toleransi, dan pemeriksaan asumsi"
slug: "pengadaan-kaca-spesifikasi"
description: "Pembaca dapat mengumpulkan input, menyatakan unit dan toleransi, memeriksa asumsi, serta menyiapkan spesifikasi survei, penawaran, pengadaan, bukti mutu, dan garansi pekerjaan kaca yang dapat ditinjau vendor."
status: outline
publication_date: "2026-02-23"
publication_date_basis: editorial_backfill
date_modified: null
parent_topic: GLA-12
primary_intent: "Menyusun spesifikasi terukur untuk survei, penawaran, pengadaan, bukti mutu, dan garansi pekerjaan kaca"
reader_community: "Kaca.co.id"
reader_address: "Sobat Kaca.co.id"
final_route: "/artikel/pengadaan-kaca-spesifikasi.html"
...
# Spesifikasi survei, penawaran, pengadaan, bukti mutu, dan garansi pekerjaan kaca: data, ukuran, toleransi, dan pemeriksaan asumsi

## Assignment lock

- **Writer task:** Expand this file into one complete article answering: “Spesifikasi survei, penawaran, pengadaan, bukti mutu, dan garansi pekerjaan kaca: data, ukuran, toleransi, dan pemeriksaan asumsi”
- **Reader and situation:** Designer, estimator, drafter, engineer, atau pembeli teknis yang menyiapkan dokumen kerja
- **Reader outcome:** Pembaca dapat mengumpulkan input, menyatakan unit dan toleransi, memeriksa asumsi, serta menyiapkan spesifikasi survei, penawaran, pengadaan, bukti mutu, dan garansi pekerjaan kaca yang dapat ditinjau vendor.
- **Primary intent:** Menyusun spesifikasi terukur untuk survei, penawaran, pengadaan, bukti mutu, dan garansi pekerjaan kaca
...
- **Scope boundary:** Tidak menggantikan desain atau persetujuan engineer untuk kondisi berisiko; detail antarmuka dimiliki GLA-12-04 dan eksekusi lapangan dimiliki GLA-12-05.
- **Final public route:** `/artikel/pengadaan-kaca-spesifikasi.html`
...
- Start with the concrete decision, confusion, risk, or costly shortcut behind **Spesifikasi survei, penawaran, pengadaan, bukti mutu, dan garansi pekerjaan kaca: data, ukuran, toleransi, dan pemeriksaan asumsi**.
...
- **Tie back to this article:** Keep the explanation specific to “Spesifikasi survei, penawaran, pengadaan, bukti mutu, dan garansi pekerjaan kaca: data, ukuran, toleransi, dan pemeriksaan asumsi”.
