---
article_id: GLA-14-03
title: "Spesifikasi retak, gompal, gores, pengembunan internal, bocor, pecah, dan penggantian kaca: data, ukuran, toleransi, dan pemeriksaan asumsi"
slug: "kerusakan-perbaikan-kaca-spesifikasi"
description: "Pembaca dapat mengumpulkan input, menyatakan unit dan toleransi, memeriksa asumsi, serta menyiapkan spesifikasi retak, gompal, gores, pengembunan internal, bocor, pecah, dan penggantian kaca yang dapat ditinjau vendor."
status: outline
publication_date: "2026-04-28"
publication_date_basis: editorial_backfill
date_modified: null
parent_topic: GLA-14
primary_intent: "Menyusun spesifikasi terukur untuk retak, gompal, gores, pengembunan internal, bocor, pecah, dan penggantian kaca"
reader_community: "Kaca.co.id"
reader_address: "Teman Kaca.co.id"
final_route: "/artikel/kerusakan-perbaikan-kaca-spesifikasi.html"
...
# Spesifikasi retak, gompal, gores, pengembunan internal, bocor, pecah, dan penggantian kaca: data, ukuran, toleransi, dan pemeriksaan asumsi

## Assignment lock

- **Writer task:** Expand this file into one complete article answering: “Spesifikasi retak, gompal, gores, pengembunan internal, bocor, pecah, dan penggantian kaca: data, ukuran, toleransi, dan pemeriksaan asumsi”
- **Reader and situation:** Designer, estimator, drafter, engineer, atau pembeli teknis yang menyiapkan dokumen kerja
- **Reader outcome:** Pembaca dapat mengumpulkan input, menyatakan unit dan toleransi, memeriksa asumsi, serta menyiapkan spesifikasi retak, gompal, gores, pengembunan internal, bocor, pecah, dan penggantian kaca yang dapat ditinjau vendor.
- **Primary intent:** Menyusun spesifikasi terukur untuk retak, gompal, gores, pengembunan internal, bocor, pecah, dan penggantian kaca
...
- **Scope boundary:** Tidak menggantikan desain atau persetujuan engineer untuk kondisi berisiko; detail antarmuka dimiliki GLA-14-04 dan eksekusi lapangan dimiliki GLA-14-05.
- **Final public route:** `/artikel/kerusakan-perbaikan-kaca-spesifikasi.html`
...
- Start with the concrete decision, confusion, risk, or costly shortcut behind **Spesifikasi retak, gompal, gores, pengembunan internal, bocor, pecah, dan penggantian kaca: data, ukuran, toleransi, dan pemeriksaan asumsi**.
...
- **TOPIC-GATE:** Site inspection and specialist/forensic review for consequential failures
...
- `/berita/penyebab-kaca-tempered-pecah-dan-pencegahannya` — use only if it helps the reader's next step; verify the anchor describes the destination.
- `/berita/mengatasi-kaca-retak-dan-goresan` — use only if it helps the reader's next step; verify the anchor describes the destination.
- `/berita/mengapa-kanopi-kaca-bisa-bocor` — use only if it helps the reader's next step; verify the anchor describes the destination.
...
- `/berita/kaca-retak-tahan-berapa-lama` — use only if it helps the reader's next step; verify the anchor describes the destination.
- `/berita/jenis-kaca-yang-tidak-mudah-retak-dan-tahan-panas` — use only if it helps the reader's next step; verify the anchor describes the destination.

### Planned sibling articles

These are future routes. Do not link them as live until their HTML exists.

- `GLA-14-01` → `/artikel/kerusakan-perbaikan-kaca-dasar.html` — Panduan dasar retak, gompal, gores, pengembunan internal, bocor, pecah, dan penggantian kaca: istilah, komponen, dan cara kerja
- `GLA-14-02` → `/artikel/kerusakan-perbaikan-kaca-pilih.html` — Cara memilih retak, gompal, gores, pengembunan internal, bocor, pecah, dan penggantian kaca: matriks keputusan berdasarkan fungsi dan risiko
- `GLA-14-04` → `/artikel/kerusakan-perbaikan-kaca-desain.html` — Detail desain retak, gompal, gores, pengembunan internal, bocor, pecah, dan penggantian kaca: antarmuka, drainase, gerak, dan akses
- `GLA-14-05` → `/artikel/kerusakan-perbaikan-kaca-pasang.html` — Tahapan pekerjaan retak, gompal, gores, pengembunan internal, bocor, pecah, dan penggantian kaca: persiapan, pemasangan, QC, dan serah terima
...
- **Tie back to this article:** Keep the explanation specific to “Spesifikasi retak, gompal, gores, pengembunan internal, bocor, pecah, dan penggantian kaca: data, ukuran, toleransi, dan pemeriksaan asumsi”.
