---
article_id: GLA-14-02
title: "Cara memilih retak, gompal, gores, pengembunan internal, bocor, pecah, dan penggantian kaca: matriks keputusan berdasarkan fungsi dan risiko"
slug: "kerusakan-perbaikan-kaca-pilih"
description: "Pembaca dapat menyaring alternatif retak, gompal, gores, pengembunan internal, bocor, pecah, dan penggantian kaca menurut fungsi, lokasi, pengguna, tingkat risiko, umur layanan, dan trade-off biaya."
status: outline
publication_date: "2026-04-23"
publication_date_basis: editorial_backfill
date_modified: null
parent_topic: GLA-14
primary_intent: "Memilih konfigurasi retak, gompal, gores, pengembunan internal, bocor, pecah, dan penggantian kaca untuk kebutuhan dan batasan tertentu"
reader_community: "Kaca.co.id"
reader_address: "Sobat Kaca.co.id"
final_route: "/artikel/kerusakan-perbaikan-kaca-pilih.html"
...
# Cara memilih retak, gompal, gores, pengembunan internal, bocor, pecah, dan penggantian kaca: matriks keputusan berdasarkan fungsi dan risiko

## Assignment lock

- **Writer task:** Expand this file into one complete article answering: “Cara memilih retak, gompal, gores, pengembunan internal, bocor, pecah, dan penggantian kaca: matriks keputusan berdasarkan fungsi dan risiko”
- **Reader and situation:** Pemilik, arsitek, engineer, estimator, atau pembeli yang membandingkan alternatif
- **Reader outcome:** Pembaca dapat menyaring alternatif retak, gompal, gores, pengembunan internal, bocor, pecah, dan penggantian kaca menurut fungsi, lokasi, pengguna, tingkat risiko, umur layanan, dan trade-off biaya.
- **Primary intent:** Memilih konfigurasi retak, gompal, gores, pengembunan internal, bocor, pecah, dan penggantian kaca untuk kebutuhan dan batasan tertentu
...
- **Scope boundary:** Tidak menghitung ukuran atau toleransi final; perhitungan dimiliki GLA-14-03. Tidak menjual jasa atau memberi harga pasar; proses penawaran dimiliki GLA-14-08.
- **Final public route:** `/artikel/kerusakan-perbaikan-kaca-pilih.html`
...
- Start with the concrete decision, confusion, risk, or costly shortcut behind **Cara memilih retak, gompal, gores, pengembunan internal, bocor, pecah, dan penggantian kaca: matriks keputusan berdasarkan fungsi dan risiko**.
...
- **Tie back to this article:** Keep the explanation specific to “Cara memilih retak, gompal, gores, pengembunan internal, bocor, pecah, dan penggantian kaca: matriks keputusan berdasarkan fungsi dan risiko”.
