---
article_id: GLA-07-01
title: "Panduan dasar jendela, pintu, dan bukaan kaca: istilah, komponen, dan cara kerja"
slug: "jendela-pintu-kaca-dasar"
description: "Pembaca dapat menjelaskan fixed/operable/sliding/swing/folding systems, safety locations, hardware, air-water behavior, egress, access, dan use cycles, istilah yang sering tertukar, komponen, mekanisme, serta pertanyaan awal yang perlu diajukan."
status: outline
publication_date: "2025-09-09"
publication_date_basis: editorial_backfill
date_modified: null
parent_topic: GLA-07
primary_intent: "Memahami fondasi jendela, pintu, dan bukaan kaca sebelum mengambil keputusan teknis"
reader_community: "Kaca.co.id"
reader_address: "Teman Kaca.co.id"
final_route: "/artikel/jendela-pintu-kaca-dasar.html"
...
# Panduan dasar jendela, pintu, dan bukaan kaca: istilah, komponen, dan cara kerja

## Assignment lock

- **Writer task:** Expand this file into one complete article answering: “Panduan dasar jendela, pintu, dan bukaan kaca: istilah, komponen, dan cara kerja”
- **Reader and situation:** Pemilik, pembeli, mahasiswa, atau staf proyek yang baru mengenal subjek
- **Reader outcome:** Pembaca dapat menjelaskan fixed/operable/sliding/swing/folding systems, safety locations, hardware, air-water behavior, egress, access, dan use cycles, istilah yang sering tertukar, komponen, mekanisme, serta pertanyaan awal yang perlu diajukan.
- **Primary intent:** Memahami fondasi jendela, pintu, dan bukaan kaca sebelum mengambil keputusan teknis
...
- **Scope boundary:** Tidak menentukan opsi terbaik untuk kasus tertentu; keputusan pilihan dimiliki GLA-07-02, sedangkan angka spesifikasi dimiliki GLA-07-03.
- **Final public route:** `/artikel/jendela-pintu-kaca-dasar.html`
...
- Start with the concrete decision, confusion, risk, or costly shortcut behind **Panduan dasar jendela, pintu, dan bukaan kaca: istilah, komponen, dan cara kerja**.
...
- **Exact Markdown to insert:** `![Ilustrasi pintu kaca 2](/wp-content/uploads/2021/04/pintu-kaca-2.jpg)`
- **Caption/credit:** Aset lokal proyek; jangan klaim sebagai dokumentasi proyek tertentu.
- **Selection basis:** filename/source metadata identifies `pintu kaca 2` as relevant content media; no pixels were inspected.
...
- `/pintu-kaca-sumedang/` — use only if it helps the reader's next step; verify the anchor describes the destination.
...
- **Tie back to this article:** Keep the explanation specific to “Panduan dasar jendela, pintu, dan bukaan kaca: istilah, komponen, dan cara kerja”.
