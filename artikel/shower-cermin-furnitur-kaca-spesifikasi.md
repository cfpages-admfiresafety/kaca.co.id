---
article_id: GLA-09-03
title: "Spesifikasi shower screen, cermin, meja, lemari, dan furnitur kaca: data, ukuran, toleransi, dan pemeriksaan asumsi"
slug: "shower-cermin-furnitur-kaca-spesifikasi"
description: "Pembaca dapat mengumpulkan input, menyatakan unit dan toleransi, memeriksa asumsi, serta menyiapkan spesifikasi shower screen, cermin, meja, lemari, dan furnitur kaca yang dapat ditinjau vendor."
status: outline
publication_date: "2025-11-20"
publication_date_basis: editorial_backfill
date_modified: null
parent_topic: GLA-09
primary_intent: "Menyusun spesifikasi terukur untuk shower screen, cermin, meja, lemari, dan furnitur kaca"
reader_community: "Kaca.co.id"
reader_address: "Teman Kaca.co.id"
final_route: "/artikel/shower-cermin-furnitur-kaca-spesifikasi.html"
...
# Spesifikasi shower screen, cermin, meja, lemari, dan furnitur kaca: data, ukuran, toleransi, dan pemeriksaan asumsi

## Assignment lock

- **Writer task:** Expand this file into one complete article answering: “Spesifikasi shower screen, cermin, meja, lemari, dan furnitur kaca: data, ukuran, toleransi, dan pemeriksaan asumsi”
- **Reader and situation:** Designer, estimator, drafter, engineer, atau pembeli teknis yang menyiapkan dokumen kerja
- **Reader outcome:** Pembaca dapat mengumpulkan input, menyatakan unit dan toleransi, memeriksa asumsi, serta menyiapkan spesifikasi shower screen, cermin, meja, lemari, dan furnitur kaca yang dapat ditinjau vendor.
- **Primary intent:** Menyusun spesifikasi terukur untuk shower screen, cermin, meja, lemari, dan furnitur kaca
...
- **Scope boundary:** Tidak menggantikan desain atau persetujuan engineer untuk kondisi berisiko; detail antarmuka dimiliki GLA-09-04 dan eksekusi lapangan dimiliki GLA-09-05.
- **Final public route:** `/artikel/shower-cermin-furnitur-kaca-spesifikasi.html`
...
- Start with the concrete decision, confusion, risk, or costly shortcut behind **Spesifikasi shower screen, cermin, meja, lemari, dan furnitur kaca: data, ukuran, toleransi, dan pemeriksaan asumsi**.
...
- `GLA-09-01` → `/artikel/shower-cermin-furnitur-kaca-dasar.html` — Panduan dasar shower screen, cermin, meja, lemari, dan furnitur kaca: istilah, komponen, dan cara kerja
...
- **Tie back to this article:** Keep the explanation specific to “Spesifikasi shower screen, cermin, meja, lemari, dan furnitur kaca: data, ukuran, toleransi, dan pemeriksaan asumsi”.
